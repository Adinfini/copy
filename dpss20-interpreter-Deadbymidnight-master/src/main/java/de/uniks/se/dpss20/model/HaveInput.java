...
public class HaveInput extends Command
{
   @Override
   public void run(MockupEditor editor) {
      Input input = (Input)editor.getOrCreate(Input.class,getId());
      DOMNode line = editor.getOrCreate(Line.class, getParentId());
      line.withKids(input);
      input.setPrompt(getPrompt());
   ...
   public HaveInput setParentId(String value)
   {
   ...
   public HaveInput setPrompt(String value)
   {
   ...
   public HaveInput setValue(String value)
   {
